...
function drawTableMKU(elem, totalElem, warningElem, gamedata)
{
	clearWarning()
	warningElem.innerHTML = ""
	totalElem.innerHTML = ""
	...
	for (let c = 0; c < clans.length; c++)
	{
		...
		clan.fontColor = c % 2 == 0 ? "#007F86" : "#CD4E00"
	}
	...
	let rankSrcs =
	[
		window.location.href.substr(0, window.location.href.lastIndexOf("/")) + "/assets/mku.png"
	]
	...
	ctx.fillText(dateStr + "    •    Mario Kart Universal" + raceStr, TOTAL_WIDTH / 2, HEADER_HEIGHT / 2, TOTAL_WIDTH)
